...
$x_0$ 를 [regular singularity](ode.qmd#sec-ode_singularity) 로 잡으면 많은 경우 미분방정식의 해를 찾는 데 유용하지만 [irregular siglularity](ode.qmd#sec-ode_singularity) 의 경우는 Frobenius 방법으로 해를 구할 수 없다.
