...
| 결정계 | 단위포 (unit cell) | 군 | 대칭 성분 갯수 |
|:--------:|:-------:|:-----:|:---------:|
| 삼사정계 (triclinic) | $a \ne b \ne c$ </br> $\alpha\ne \beta \ne \gamma$ | $C_1$ </br> $S_2(C_1)$ | 1 </br> 2 |
| 단사정계 (monoclinic) | $a\ne b \ne c$ </br> $\alpha=\gamma = \dfrac{\pi}{2} \ne \beta$ | $C_{1h}$ </br> $C_2$ </br> $C_2h$ | 2 </br> 2 </br> 4 |
| 사방정계 (orthorhombic) | $a \ne b \ne c$ </br> $\alpha=\beta=\gamma = \dfrac{\pi}{2}$ | $C_{2v}$ </br> $D_2(V)$ </br> $D_{2h}(V_h)$ | 4 </br> 4 </br> 8 |
| 정방정계 (tetragonal) | $a=b\ne c$ </br> $\alpha=\beta=\gamma = \dfrac{\pi}{2}$ | $C_4$ </br> $S_4$ </br> $C_{4h}$ </br> $D_{2d}(V_d)$ </br> $C_{4v}$ </br> $D_4$ </br> $D_{4h}$ | 4 </br> 4 </br> 8 </br> 8 </br> 8 </br>8 </br> 16 |
| 삼방정계 (rhombohedral) | $a=b = c$ </br> $\alpha=\beta=\gamma < \dfrac{2\pi}{3} \ne \dfrac{\pi}{2}$ | $C_3$ </br> $S_6(C_{3i})$ </br> $C_{3v}$ </br> $D_3$ </br> $D_{3d}$ | 3 </br> 6 </br> 6 </br> 6 </br> 12 |
| 육방정계 (hexagonal) | $a=b\ne c$ </br> $\alpha = \beta = \dfrac{\pi}{2},\, \gamma = \dfrac{2\pi}{3}$ | $C_{3h}$ </br> $C_6$ </br> $C_{6h}$ </br> $D_{3h}$ </br> $C_{6v}$ </br> $D_6$ </br> $D_{6h}$ | 6 </br> 6 </br> 12 </br> 12 </br> 12 </br> 12 </br> 24 |
| 입방정계 (cubic) | $a=b=c$ </br> $\alpha = \beta = \gamma = \dfrac{\pi}{2}$ | $T$ </br> $T_h$ </br> $T_d$ </br> $O$ </br> $O_h$ | 12 </br> 24 </br> 24 </br> 24 </br> 48|
