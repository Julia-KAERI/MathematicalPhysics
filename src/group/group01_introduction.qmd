...
::: {#prp-Group_properties_on_conjugate_class}

군 $G$ 에 대해 다음이 성립한다.

&emsp;($1$) 항등원 $i_G$ 에 대해 $\{i_G\}$ 는 conjugate class 이다.

&emsp;($2$) $G$ 가 아벨군이면 모든 $g\in G$ 에 대해 $\{g\}$ 는 conjugate class 이다.
...
::: {.proof}
($1$), ($2$) 는 자명하며 ($3$) 은 @exr-Arfken_17_1_4
:::
...
@prp-Group_properties_on_conjugate_class ($3$) 를 증명하라.
