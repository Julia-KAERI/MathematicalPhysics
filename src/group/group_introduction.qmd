...
5. $g\in G$ 에 대해 $\{g^k:k\in \Z\}=G$ 일 때 $G$ 를 **순환군 (cyclic group)** 이라고 하고 $G=\langle g \rangle$ 이라고 표기한다. 이 때 $G$ 는 $g$ 에 의해 생성된다고 한다.
...
$N\trianglelefteq G$ 라고 하자. 그리고 $N$ 에 의한 왼쪽 잉여류의 집합 $\{N,\,g_1N,\ldots,\, g_nN\}$ 를 생각하자. 임의의 $g_1,\,g_2\in G,\, n_1,\,n_2\in N$ 에 대해 $g_1n_1\in g_1N,\, g_2n_2\in g_2N$ 이며
