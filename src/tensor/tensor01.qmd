...
첫번째 관성계의 벡터 $(A^0,\, A^1,\,A^2,\,A^3)$ 와 두번째 관성계의 좌표 $(A'^0,\,A'^1,\,A'^2,\,A'^3)$ 에서 $A^1=A^2=A^3=A'^1=A'^2=A'^3=0$ 이라고 하자. $(A')^0$ 에 대해
...
좌표축에 관하나 $90^\circ$, $180^\circ$ 회전을 생각하여 3차원 공간에서의 2차 텐서 가운데 등방 텐서인 것은 $\delta^i_j$ 의 스칼라 곱 밖에 없음을 보여라.
:::
...
첫번째 축에 대한 90도 회전을 생각하면

$$
A'^{22}= \dfrac{\partial x'^2}{\partial x_i}\dfrac{\partial x'^2}{\partial x_j}A^{ij} = A^{33}
$$

이다. 등방 텐서이므로 $A'^{22} = A^{22}$ 이어야 한다. 두번째, 세번째 축에 대한 90 도 회전을 생각하면
...
$$
A'^{12} = \dfrac{\partial x'^1}{\partial x_i}\dfrac{\partial x'^2}{\partial x_j}A^{ij}= A^{13}
$$

이다. 등방 텐서이므로 $A'^{13}=A^{13}$ 이며

$$
A'^{13} = \dfrac{\partial x'^1}{\partial x_i}\dfrac{\partial x'^3}{\partial x_j}A^{ij} = -A^{12}
$$
