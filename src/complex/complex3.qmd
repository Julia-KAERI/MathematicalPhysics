...
$$
\begin{aligned}
\text{Res}(f,\,z_1) &=\dfrac{z_1^2}{(z_1-z_2)(z_1-z_3) (z_1-z_4)} =  \dfrac{i}{\sqrt{2}\cdot \sqrt{2}(1+i) \cdot \sqrt{2}i} = \dfrac{1-i}{4\sqrt{2}}\\
\text{Res}(f,\,z_2) &= \dfrac{z_2^2}{(z_2-z_1)(z_2-z_3)(z_2-z_4)} = \dfrac{-i}{(-\sqrt{2}) \cdot (\sqrt{2}i) \cdot (-\sqrt{2}(1-i))} = -\dfrac{1+i}{4\sqrt{2}}
\end{aligned}
$$
