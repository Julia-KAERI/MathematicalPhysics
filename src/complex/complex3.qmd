...
보통 @eq-complex3_infinity_integral 형태의 적분을 계산 할 때 위의 두 조건을 만족하는 복소평면의 위쪽이나 아래쪽 반평면을 선택하게 된다. 우선 위쪽 반평면을 생각하기로 하자. 그리고 아래 @fig-complex3_infinite_integral 와 같은 contour 를 생각한다. $z_1,\,z_2,\ldots$ 는 극점이며 contour $C$ 는 $C_R+C_I$ 라고 하자. 

![큰 반원으로 둘러쌓인 위쪽 반평면에서의 contour](figures/fig-complex_infinite_integral.png){#fig-complex3_infinite_integral width=400}
...
우리는 @fig-complex3_infinite_integral 에서의 위쪽 반평면에서의 $C_R,\,C_I$ 로 이루어진 contour 를 생각하자. $C_R$ 에서의 적분을 $I_R$ 이라고 하고 $z=Re^{i\theta}$ 로 잡자.
...
![Contour](figures/fig-complex_integral_without_symmetry.png){#fig-complex_integral_without_symmetry width=300}
...
![Contour](figures/fig-complex_integral_avoiding_branch.png){#fig-complex_integral_avoiding_branch width=300}
...
![Contour](figures/fig-complex_exploiting_branch_cuts.png){#fig-complex3_exploiting_branch_cuts width=350}
...
![Contour](figures/fig-complex_exploiting_periodicity_1.png){#fig-complex3_exploiting_periodicity_1 width=400}
...
![Contour](figures/fig-complex_contour_Arfken_11_8_13.png){#fig-complex3_contour_Arfket_11_8_13 width=350}
:::
...
![Contour](figures/fig-complex_contour_Arfken_11_8_14.png){#fig-complex3_contour_Arfken_11_8_14.png}
...
![Contour](figures/fig-complex_contour_Arfken_11_8_18.png){#fig-complex3_contour_Arfken_11_8_18 width=400}
