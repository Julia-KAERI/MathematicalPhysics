...
![원점 주위의 $z^{1/2}$ 값을 계산하기 위한 경로](figures/fig-complex_branch_1.png){#fig-complex2_branch_1 width=300}
...
![원점 주위가 아닌, $z^{1/2}$ 값을 계산하기 위한 경로](figures/fig-complex_branch_2.png){#fig-complex2_branch_2 width=350}
...
![가능한 브랜치중의 하나](figures/fig-complex_branch_3.png){#fig-complex2_branch_3  width=300}
...
![Branch cut 주위의 경로](figures/fig-complex_branch_4.png){#fig-complex2_branch_4 width=450}
...
![고립점을 제외한 경로 잡기](figures/fig-complex_residue_1.png){#fig-complex2_residue_1 width=300}
...
![$1/z$ 적분에 있어서의 코시 주요값 소거](figures/fig-complex_cauchy_principal_value_1.png){#fig-complex2_cauchy_principal_value width=400}
...
![코시 주요값 적분을 포함하는 contour](figures/fig-complex_cauchy_principal_value_2.png){#fig-complex2_cauchy_principal_value_2 width=400}
...
![단위 계단 함수의 복소 적분 표현 1](figures/fig-complex_cauchy_principal_value_3.png){#fig-complex_cauchy_principal_value_3 width=600}
